...
function VideoCallModal({ user }) {
  ...
  return (
    <Dialog open={Boolean(ongoingCall)} fullScreen>
...

        {
          ...
          ongoingCall?.isRinging && ongoingCall?.reciever && (
            <>
              ...
              >
                {ongoingCall.call.metadata?.caller || "Someone "} is calling
              </Typography>
              <Button
      ...
      >
        <CallTimer isCallActive={ongoingCall?.accepted}/>
      </Box>
      ...
      {ongoingCall && (
        ...
        >
          ...
          <IconButton
            onClick={() => toggleCamera(localVideo)}
